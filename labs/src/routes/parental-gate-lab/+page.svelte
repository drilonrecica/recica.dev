<script lang="ts">
	import ParentalGateGuidance from '$lib/components/parental-gate/ParentalGateGuidance.svelte';
	import ParentalGateIntro from '$lib/components/parental-gate/ParentalGateIntro.svelte';
